...
public final class Constants {
  ...
  public static final class FuelConstants {
    ...
    public static final double INTAKING_ARM_VOLTAGE = 5;
    public static final double INTAKING_INTAKE_VOLTAGE = 11;
    public static double LAUNCHING_LAUNCHER_VOLTAGE = 9.6;
    public static double SPIN_UP_FEEDER_VOLTAGE = 12;
