...
public class Shooter extends SubsystemBase {
  private final SparkMax launchingLaunch;
  private final SparkMax spinUpFeeder;

  /** Creates a new CANBallSubsystem. */
  @SuppressWarnings("removal")
  public Shooter() {
    // create brushless motors for each of the motors on the launcher mechanism
    launchingLaunch = new SparkMax(LAUNCHER_MOTOR_ID, MotorType.kBrushless);
    spinUpFeeder = new SparkMax(SPIN_UP_MOTOR_ID, MotorType.kBrushless);
    ...
    SparkMaxConfig launchingLaunchConfig = new SparkMaxConfig();
